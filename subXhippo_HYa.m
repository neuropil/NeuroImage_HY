function [allCaseD , allSTATS] = subXhippo_HYa(outFlag,ICVFlag)
...
[allCaseD] = getDATA(2, subTab, hippoSegTable, bNames, ICVFlag,outFlag, 'PD');
...
function [dataOUTmain] = getDATA(groupNum, subTab, totalSegTable, brFlag, ICVFlag,outFlag, condI)
